(function(){
    ...
    function EventosCtrl(){
        var eventos = this;
        eventos.palabraEvento = "eventos";
        ...
        function CalendarApp(date) {
            ...
            this.todayIsSpan.textContent = "Hoy es " + date.getDate() + " de " + this.months[date.getMonth()];
        }
...
CalendarApp.prototype.openDayWindow = function(date){
  ...
  _dayTopbarText === "Tienes 1 " ? eventos.palabraEvento = "evento - ": eventos.palabraEvento = "eventos - " ;

  this.dayEventsEle.textContent = _dayTopbarText + eventos.palabraEvento + this.months[day.getMonth()] + " " + day.getDate() + ", " + day.getFullYear();

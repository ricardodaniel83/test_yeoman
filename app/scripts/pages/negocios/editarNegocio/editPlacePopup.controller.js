(function(){
    ...
    angular
        ...
        .controller('editPlacePopupCtrl', editPlacePopupCtrl);

        editPlacePopupCtrl.$inject = ['$uibModalInstance', 'data', 'placeService', 'categoryService',];

        function editPlacePopupCtrl ($uibModalInstance, data, placeService, categoryService){
        var editarNegocio = this;

          editarNegocio.data = data.objeto;
         ...
         function actualizarRangoPrecios(){
              if(angular.isUndefined(editarNegocio.data.price_range) == true || editarNegocio.data.price_range.length == 0)
                  editarNegocio.data.price_range =[0,0];
          }
         ...
         function eliminarServicio(servicio){
          ...
          function guardar(){
              ...
              data[0].price_range = editarNegocio.data.price_range;

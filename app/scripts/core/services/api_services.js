      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Files/:id",
          { 'id': '@id' },
          {
            ...
            "getFiles": {
              isArray: true,
              url: urlBase + "/Files/files",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.File#updateFiles
             * @methodOf lbServices.File
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.File#eliminate
             * @methodOf lbServices.File
             *
             * @description
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/users/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.User#updateMany
             * @methodOf lbServices.User
             *
             * @description
             *
            ...
            // INTERNAL. Use Place.users() instead.
            "::get::Place::users": {
              isArray: true,
              url: urlBase + "/Places/:id/users",
              method: "GET",
            },
 ...
 * **Details**
 *
 * Represents the union of several users
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Teams/:id",
          { 'id': '@id' },
          {
             ...
             * @param {Object} postData Request data.
             *
             *  - `team` – `{object}` - Object to create or update
             *
             *  - `userId` – `{string}` - Id of the user running
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Team#joinOrLeave
             * @methodOf lbServices.Team
             *
             * @description
             *
             ...
             * @param {Object} postData Request data.
             *
             *  - `join` – `{boolean}` - true to Join, false to Leave
             *
             *  - `userId` – `{string}` - Id of the user running
             *
             *  - `teamId` – `{string}` - Id of the team join
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             */
            "joinOrLeave": {
              url: urlBase + "/Teams/joinOrLeave",
              method: "PUT",
            },

            /**
             * @ngdoc method
             * @name lbServices.Team#filterTeam
             * @methodOf lbServices.Team
             *
             * @description
             *
             * Get team for user and property
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string=}` -
            ...
            "filterTeam": {
              isArray: true,
              url: urlBase + "/Teams/filter",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Team#updateMany
             * @methodOf lbServices.Team
             *
             * @description
             *
             ...
             */
            "updateMany": {
              url: urlBase + "/Teams/updateMany",
              method: "PUT",
            },

            /**
             * @ngdoc method
             * @name lbServices.Team#without
             * @methodOf lbServices.Team
             *
             * @description
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Friends/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Friend#getFriend
             * @methodOf lbServices.Friend
             *
             * @description
             *
             * Get full relation User and Friend
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string}` -
            ...
            /**
             * @ngdoc method
             * @name lbServices.Friend#putFriend
             * @methodOf lbServices.Friend
             *
             * @description
             *
             * Create or update relationship between the user and Friend.
             *
             * @param {Object=} parameters Request parameters.
             *
             *   This method does not accept any parameters.
            ...
            /**
             * @ngdoc method
             * @name lbServices.Friend#getFriends
             * @methodOf lbServices.Friend
             *
             * @description
             *
...
/**
 * @ngdoc object
 * @name lbServices.UserPlace
 * @header lbServices.UserPlace
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `UserPlace` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/UsersPlaces/:id",
          { 'id': '@id' },
          {

            /**
             * @ngdoc method
             * @name lbServices.UserPlace#getUserPlace
             * @methodOf lbServices.UserPlace
             *
             * @description
             *
             * Get full relation Place and User
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string}` -
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `UserPlace` object.)
             * </em>
             */
            "getUserPlace": {
              url: urlBase + "/UsersPlaces",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.UserPlace#putUserPlace
             * @methodOf lbServices.UserPlace
             *
             * @description
             *
             * Create or update relationship between the user and place.
             *
             * @param {Object=} parameters Request parameters.
             *
             *   This method does not accept any parameters.
            ...
            /**
             * @ngdoc method
             * @name lbServices.UserPlace#getFavoritePlaces
             * @methodOf lbServices.UserPlace
             *
             * @description
             *
             * List Favorite Places for User
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string}` -
             ...
             */
            "getFavoritePlaces": {
              url: urlBase + "/UsersPlaces/favorites",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.UserPlace#getBusiness
             * @methodOf lbServices.UserPlace
             *
             * @description
             *
             * List business registered by the user
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string}` -
             ...
             */
            "getBusiness": {
              url: urlBase + "/UsersPlaces/business",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.UserPlace#getMapped
             * @methodOf lbServices.UserPlace
             *
             * @description
             *
             * List places mapped  by the user
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string}` -
             ...
             */
            "getMapped": {
              url: urlBase + "/UsersPlaces/mapped",
              method: "GET",
            },
          }
        );
        ...
        /**
        * @ngdoc property
        * @name lbServices.UserPlace#modelName
        * @propertyOf lbServices.UserPlace
        * @description
        * The name of the model represented by this $resource,
        * i.e. `UserPlace`.
        */
        R.modelName = "UserPlace";
...
/**
 * @ngdoc object
 * @name lbServices.Recommendation
 * @header lbServices.Recommendation
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Recommendation` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/Recommendations/:id",
          { 'id': '@id' },
          {

            /**
             * @ngdoc method
             * @name lbServices.Recommendation#create
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Recommendation` object.)
             * </em>
             */
            "create": {
              url: urlBase + "/Recommendations",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Recommendation#createMany
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recommendation#deleteById
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
             ...
             */
            "deleteById": {
              url: urlBase + "/Recommendations/:id",
              method: "DELETE",
            },

            /**
             * @ngdoc method
             * @name lbServices.Recommendation#prototype$updateAttributes
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recommendation#getRecommendation
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
             * List Recommendation Usuarios o Places
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `userId` – `{string=}` -
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recommendation#destroyById
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recommendation#removeById
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recommendation#patchAttributes
             * @methodOf lbServices.Recommendation
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Recommendation#modelName
        * @propertyOf lbServices.Recommendation
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Recommendation`.
        */
        R.modelName = "Recommendation";
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Places/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Place.categories() instead.
            "prototype$__get__categories": {
              isArray: true,
              url: urlBase + "/Places/:id/categories",
              method: "GET",
            },

            // INTERNAL. Use Place.tags() instead.
            "prototype$__get__tags": {
              isArray: true,
              url: urlBase + "/Places/:id/tags",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Place#statusPlaces
             * @methodOf lbServices.Place
             *
             * @description
             *
             * List Places by Status, returns everything if not specified
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `status` – `{string=}` -
            ...
            /**
             * @ngdoc method
             * @name lbServices.Place#getPlaceById
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Get Place and all Relation Objects
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `placeId` – `{string}` -
            ...
            "getPlaceById": {
              isArray: true,
              url: urlBase + "/Places/full",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Place#mapping
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Create Place and all Relation Objects
             *
             * @param {Object=} parameters Request parameters.
             *
             *   This method does not accept any parameters.
             ...
             */
            "mapping": {
              url: urlBase + "/Places/mapping",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Place#verify
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Approve place if the information is correct
             *
             * @param {Object=} parameters Request parameters.
             *
             *   This method does not accept any parameters.
             ...
             * @param {Object} postData Request data.
             *
             *  - `placeId` – `{string}` - Id of the place to verify
             *
             *  - `editorId` – `{string}` - Editor that checks
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             */
            "verify": {
              url: urlBase + "/Places/verify",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Place#updatePlace
             * @methodOf lbServices.Place
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Place#importPlace
             * @methodOf lbServices.Place
             *
             * @description
             *
            ...
            // INTERNAL. Use Category.places() instead.
            "::get::Category::places": {
              isArray: true,
              url: urlBase + "/Categories/:id/places",
              method: "GET",
            },

            // INTERNAL. Use Tag.places() instead.
            "::get::Tag::places": {
              isArray: true,
              url: urlBase + "/Tags/:id/places",
              method: "GET",
            },

            // INTERNAL. Use Status.places() instead.
            "::get::Status::places": {
              isArray: true,
              url: urlBase + "/Statuses/:id/places",
              method: "GET",
            },
          }
        );
        ...
        */
        R.modelName = "Place";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Place#users
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Queries users of Place.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.users = function() {
          ...
          var action = TargetResource["::get::Place::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Place#categories
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Queries categories of Place.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.categories = function() {
          ...
          var action = TargetResource["::get::Place::categories"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Place#tags
             * @methodOf lbServices.Place
             *
             * @description
             *
             * Queries tags of Place.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.tags = function() {
          ...
          var action = TargetResource["::get::Place::tags"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        R.modelName = "Category";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Category#places
             * @methodOf lbServices.Category
             *
             * @description
             *
             * Queries places of Category.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.places = function() {
          var TargetResource = $injector.get("Place");
          var action = TargetResource["::get::Category::places"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        R.modelName = "Tag";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Tag#places
             * @methodOf lbServices.Tag
             *
             * @description
             *
             * Queries places of Tag.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.places = function() {
          var TargetResource = $injector.get("Place");
          var action = TargetResource["::get::Tag::places"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        R.modelName = "Status";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Status#places
             * @methodOf lbServices.Status
             *
             * @description
             *
             * Queries places of Status.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.places = function() {
          var TargetResource = $injector.get("Place");
          var action = TargetResource["::get::Status::places"];
          return action.apply(R, arguments);
        };
